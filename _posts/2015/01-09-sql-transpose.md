...
## 참고
* [Three Ways To Transpose Rows Into Columns in Oracle SQL](http://oracletuts.net/sql/three-ways-to-transpose-rows-into-columns-in-oracle-sql/) Oracle에서 행/열을 전환하는 방법을 설명한다.
